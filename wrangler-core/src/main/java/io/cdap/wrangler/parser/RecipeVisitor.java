 ...
 */
 ...
 public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
   ...
   /**
    * Visits the byteSizeArg rule, creating a ByteSize token from the BYTE_SIZE token text.
    */
   @Override
   ...
   /**
    * Visits the timeDurationArg rule, creating a TimeDuration token from the TIME_DURATION token text.
    */
   @Override
   ...
   /**
    * Visits the value rule, handling various token types including Text for AggregateStats units.
    */
   @Override
